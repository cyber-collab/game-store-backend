                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="description" id="description" cols="30" rows="10"
                                                              class="" placeholder="Description"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="additional_code" id="additional_code"
                                                       class="form-control" required>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    <div class="custom-control custom-checkbox">
                                                      {{--  <input class="custom-control-input" type="checkbox"
                                                               id="quantity" name="quantity" checked>
                                                        <label for="quantity" class="custom-control-label">Track
                                                            Quantity</label>--}}
                                                    </div>
                                                </div>
                                                <div class="mb-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="checkbox" name="top_sales" id="top_sales" value="1">
                                            </div>
                                        </div>
                                    </div>
                                </div>
